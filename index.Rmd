...
.medium-par[En esta ocasión los relatores somos **Nicolás** y **Gonzalo**].
...
```{r, echo = F, warning=F, out.width = "700px", out.height="300px"}
library(guaguas)
library(dplyr)
library(stringr)
library(ggplot2)
...
guaguas %>% 
  ...
  labs(x = "año", y = "total inscripciones",
       title = "Inscripciones de nombres de asistentes al Curso R",
       subtitle = "Fuera Vicente, Nicolás y Rodrigo") +
  theme_bw()
